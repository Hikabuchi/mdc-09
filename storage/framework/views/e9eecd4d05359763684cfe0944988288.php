        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="#" class="nav-link px-2 link-secondary">Жанры</a></li>
                    <li><a href="#" class="nav-link px-2 link-body-emphasis">Режиссеры</a></li>
                </ul>

                <form class=" d-flex col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search" method="get" action="search">
                    <input type="search" name="search" class="form-control" placeholder="Найти..." aria-label="Search">
