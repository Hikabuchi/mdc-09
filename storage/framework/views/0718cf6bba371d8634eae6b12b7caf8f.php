<?php $__env->startSection('title', 'Актеры'); ?>
        ...
        <div class="container">
            ...
            <div class="bd-example m-0 border-0">
                <div class="my-5">
                    ...
                    <div class="row text-center">
                        <div class="col-3 border"><?php echo e($actor -> name); ?></div>
                        <div class="col-1 border"><?php echo e($actor -> year_of_birth); ?></div>
                        <div class="col-5 border"><?php echo e($actor -> image); ?></div>
                        <div class="col-3 border d-flex">
                            <a href="/actors/<?php echo e($actor -> id); ?>/edit/" class="btn btn-primary">Редактировать</a>
                            <form action="<?php echo e(route('actors.destroy',$actor->id)); ?>" method="post">
...
<?php echo $__env->make('theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/actors/actors.blade.php ENDPATH**/ ?>