<?php $__env->startSection('title', 'Режиссёры'); ?>
            ...
            <div class="bd-example m-0 border-0">
                <div class="my-5">
                    ...
                    <?php $__currentLoopData = $producers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row text-center">
                            <div class="col-6 border"><?php echo e($producer -> name); ?></div>
                            <div class="col-6 border d-flex">
                                <a href="/producers/<?php echo e($producer -> id); ?>/edit/" class="btn btn-primary">Редактировать</a>
                                <form action="<?php echo e(route('producers.destroy',$producer->id)); ?>" method="post">
                                    <?php echo method_field('DELETE'); ?>
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo e($producer->id); ?>">
...
<?php echo $__env->make('theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/producers/producers.blade.php ENDPATH**/ ?>