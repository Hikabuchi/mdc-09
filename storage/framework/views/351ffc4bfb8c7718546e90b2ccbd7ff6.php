...
<?php $__env->startSection('content'); ?>
    <div class="d-flex">
        ...
        <div class="container">
            ...
            <a href="countries/create">Добавить страну</a>
            <div class="bd-example m-0 border-0">
                <div class="my-5">
                    ...
                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row text-center">
                            <div class="col-6 border"><?php echo e($country -> name); ?></div>
                            <div class="col-6 border d-flex">
                                <a href="/countries/<?php echo e($country -> id); ?>/edit/" class="btn btn-primary">Редактировать</a>
...
<?php echo $__env->make('theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/country/country_list.blade.php ENDPATH**/ ?>